...
#+source: load-amssymb
#+begin_src latex :exports code
  \ifthenelse{\boolean{ORGART@noamssymb}\or\equal{fontset}{utopia}\or\equal{fontset}{charter}\or\equal{fontset}{garamond}\or\equal{fontset}{times}}
  {}
...
#+begin_src latex :exports code
  \pgfkeys{
    /ORGART/.cd,
    fontset/times/.code={\AtBeginDocument{\ifpdf
        \RequirePackage[T1]{fontenc}
...
#+begin_src latex :exports code
  \pgfkeys{
    /ORGART/.cd,
    fontset/garamond/.code={\AtBeginDocument{\ifpdf
        \RequirePackage[T1]{fontenc} 
...
#+begin_src latex :exports code
  \pgfkeys{
    /ORGART/.cd,
    fontset/utopia/.code={\AtBeginDocument{\ifpdf
        \RequirePackage[T1]{fontenc} 
...
#+begin_src latex :exports code
  \pgfkeys{
    /ORGART/.cd,
    fontset/charter/.code={\AtBeginDocument{\ifpdf
     \RequirePackage[T1]{fontenc} 
