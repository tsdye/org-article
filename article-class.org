...
#+LaTeX_CLASS_OPTIONS: [koma,letterpaper,fontset=bera,11pt,source=minted,mintedstyle=emacs,microtype,paralist,colorlinks=true,urlcolor=blue,secnum=section,gantt]
