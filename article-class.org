...
#+LaTeX_CLASS_OPTIONS: [koma,letterpaper,utopia,11pt,minted,mintedstyle=autumn,microtype,paralist,colorlinks=true,urlcolor=blue,secnums,gantt]
...
You will need to ensure that Org-mode doesn't output for the [[latex:package][listings]]
package and that it recognizes that the [[latex:package][minted]] package is being used,
instead. 
...
#+begin_src emacs-lisp :exports code :results silent
  ...
  (setq org-export-latex-minted-with-line-numbers t)
...
#+source: pgf-mintedstyle-code
#+begin_src latex :exports code
  \pgfkeys{ 
    /ORGART/.cd, 
    mintedstyle/.is choice,
    mintedstyle/monokai/.code={\usemintedstyle{monokai}},
    mintedstyle/manni/.code={\usemintedstyle{manni}},
    mintedstyle/perldoc/.code={\usemintedstyle{perldoc}},
    mintedstyle/borland/.code={\usemintedstyle{borland}},
    mintedstyle/colorful/.code={\usemintedstyle{colorful}},
    mintedstyle/murphy/.code={\usemintedstyle{murphy}},
    mintedstyle/trac/.code={\usemintedstyle{trac}},
    mintedstyle/tango/.code={\usemintedstyle{tango}},
    mintedstyle/fruity/.code={\usemintedstyle{fruity}},
    mintedstyle/autumn/.code={\usemintedstyle{autumn}},
    mintedstyle/vs/.code={\usemintedstyle{vs}},
    mintedstyle/bw/.code={\usemintedstyle{bw}},
    mintedstyle/emacs/.code={\usemintedstyle{emacs}},
    mintedstyle/pastie/.code={\usemintedstyle{pastie}},
    mintedstyle/friendly/.code={\usemintedstyle{friendly}},
    mintedstyle/native/.code={\usemintedstyle{native}},
    mintedbg/.is choice,
    mintedbg/lightestgray/.code={\definecolor{mintedbackgroundcolor}{rgb}{0.95,0.95,0.95}}
    mintedbg/lightergray/.code={\definecolor{mintedbackgroundcolor}{rgb}{0.9,0.9,0.9}}    
    mintedbg/lightgray/.code={\definecolor{mintedbackgroundcolor}{rgb}{0.85,0.85,0.85}}    
    mintedfontfamily/.is choice,
    mintedfontfamily/
    mintedfontsize/.is choice,
    mintedframe/.is choice,
    mintedlinenumbers/.is choice,
  } 
#+end_src
